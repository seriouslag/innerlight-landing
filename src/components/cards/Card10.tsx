...
/** The Luminary Bar -- Warm / Sand Glow front with hexagon icon, contact back with corner hexagon watermark. */
export function Card10({ config }: Card10Props) {
  ...
  return (
    <div className="card-pair">
      <div className="card-wrapper">
        ...
        <div className="card card-10-front">
      ...
      <div className="card-wrapper">
        ...
        <div className="card card-10-back">
