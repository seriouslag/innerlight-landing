...
/** The Luminary Bar -- navy glow front with hexagon icon, contact back with corner hexagon watermark. */
export function Card8({ config }: Card8Props) {
  ...
  return (
    <div className="card-pair">
      <div className="card-wrapper">
        ...
        <div className="card card-8-front">
      ...
      <div className="card-wrapper">
        ...
        <div className="card card-8-back">
