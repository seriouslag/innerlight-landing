...
/** The Spectrum Bar -- Warm / Sand Spectrum front with logo image, contact back with corner logo watermark. */
export function Card11({ config }: Card11Props) {
  ...
  return (
    <div className="card-pair">
      <div className="card-wrapper">
        ...
        <div className="card card-11-front">
          <img
            className="logo-img"
      ...
      <div className="card-wrapper">
        ...
        <div className="card card-11-back">
          <img
